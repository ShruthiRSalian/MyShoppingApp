...
class CheckoutViewController: UIViewController, StoryboardInstantiable {
    ...
    static func create(with viewModel: CheckoutViewModel) -> CheckoutViewController {
        let view = CheckoutViewController.instantiateViewController()
        view.checkoutViewModel = viewModel
        return view
    }
